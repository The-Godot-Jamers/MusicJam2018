...
func _ready():
	Globals.lvl = 5
	#print($IcosSphere.mesh.surface_get_material(0))
	#$IcosSphere.mesh.surface_get_material(0).set_shader_param("rand_seed", rand_range(0.1,0.9))
	make_asteroid_shape()
...
func make_asteroid_shape():
	...
	surf.create_from_surface($IcosSphere.mesh, 0)
